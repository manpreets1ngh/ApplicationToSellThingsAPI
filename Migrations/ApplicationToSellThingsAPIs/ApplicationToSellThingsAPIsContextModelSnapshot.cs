...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationToSellThings.APIs.Areas.Identity.Data.ApplicationToSellThingsAPIsUser", b =>
                {
                    ...
                    b.ToTable("ApplicationToSellThingsAPIsUser");
                });
            ...
            modelBuilder.Entity("ApplicationToSellThings.APIs.Models.AddressResponseViewModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApplicationToSellThings.APIs.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ApplicationToSellThings.APIs.Models.Order", b =>
                {
                    b.HasOne("ApplicationToSellThings.APIs.Models.AddressModel", "ShippingAddress")
                        .WithMany()
                        .HasForeignKey("ShippingAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationToSellThings.APIs.Models.ShippingInfoModel", "ShippingInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("ApplicationToSellThings.APIs.Models.OrderDetail", b =>
                {
                    b.HasOne("ApplicationToSellThings.APIs.Models.AddressResponseViewModel", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationToSellThings.APIs.Models.Order", null)
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationToSellThings.APIs.Models.Product", "Product")
                        .WithMany()
